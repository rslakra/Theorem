...
public class FindReverse {
     ...
     * @param riverSizes
     */
    public void traverseNodes(int[][] matrix, int row, int column, boolean[][] visited, List<Integer> riverSizes) {
        int countRevers = 0;
    ...
    public List<Integer> riverSizes(int[][] matrix) {
        ...
        for (int i = 0; i < matrix.length; i++) {
            for (int j = 0; j < matrix[i].length; j++) {
                if (!visited[i][j]) {
                    traverseNodes(matrix, i, j, visited, riverSizes);
                }
            }
        }
    ...
    public static void main(String[] args) {
        FindReverse findReverse = new FindReverse();
        int[][] matrix = findReverse.initRevers(1, 1);
        System.out.println("Input:");
        findReverse.printRevers(matrix);
        System.out.println("Output:");
        System.out.println(findReverse.riverSizes(matrix));
        System.out.println(findReverse.riverSizesRecursively(matrix));

        matrix = findReverse.initRevers(1, 3);
        System.out.println("\nInput:");
        findReverse.printRevers(matrix);
        System.out.println("Output:");
        System.out.println(findReverse.riverSizes(matrix));
        ...
        matrix = findReverse.initRevers(2, 3);
        System.out.println("\nInput:");
        findReverse.printRevers(matrix);
        System.out.println("Output:");
        System.out.println(findReverse.riverSizes(matrix));
        ...
        matrix = findReverse.initRevers(3, 4);
        System.out.println("\nInput:");
        findReverse.printRevers(matrix);
        System.out.println("Output:");
        System.out.println(findReverse.riverSizes(matrix));
        ...
        matrix = findReverse.initRevers(4, 5);
        System.out.println("\nInput:");
        findReverse.printRevers(matrix);
        System.out.println("Output:");
        System.out.println(findReverse.riverSizes(matrix));
        ...
        matrix = findReverse.initRevers(5, 5);
        System.out.println("\nInput:");
        findReverse.printRevers(matrix);
        System.out.println("Output:");
        System.out.println(findReverse.riverSizes(matrix));
        ...
        matrix = findReverse.initRevers(5, 6);
        System.out.println("\nInput:");
        findReverse.printRevers(matrix);
        System.out.println("Output:");
        System.out.println(findReverse.riverSizes(matrix));
