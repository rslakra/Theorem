...
public class BinaryTreeTest extends AbstractTreeTest {
    ...
    public void testBinaryTree() {
        BinaryTree<String> tree = buildBinaryTree(Arrays.asList("India", "United States", "China", "Japan", "Indonesia", "Australia", "Nepal"));
    ...
    public void testFindNode() {
        BinaryTree<Integer> tree = buildBinaryTree(Arrays.asList(10, 7, 5, 9, 6, 8, 16));
        LOGGER.debug("Size:{}, tree:{}", tree.getSize(), tree);
        assertNotNull(tree);
        assertEquals(7, tree.getSize());
    ...
    public void testTreeTraversal() {
        BinaryTree<Integer> tree = buildBinaryTree(Arrays.asList(10, 7, 5, 9, 16));
        assertNotNull(tree);
    ...
    public void testRemoveNode() {
        ...
        BinaryTree<Integer> tree = buildBinaryTree(Arrays.asList(10, 7, 5, 9, 16, 13, 18, 20));
        LOGGER.debug("Size:{}, tree:{}", tree.getSize(), tree);
        assertNotNull(tree);
