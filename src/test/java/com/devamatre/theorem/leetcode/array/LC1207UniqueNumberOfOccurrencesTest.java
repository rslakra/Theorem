...
import com.devamatre.theorem.leetcode.array.LC1207UniqueNumberOfOccurrences;
...
public class LC1207UniqueNumberOfOccurrencesTest {
    ...
    private Iterator<Object[]> inputData() {
        ...
        input.add(new Object[]{
            new int[]{-264, 136, 159, -178, 159, 116, -78, -58, -93, 136, 159, -118, 86, 136, 159, -264, -264, -20, -78,
                      ...
                      -178, 159, -178, -20, -264, -55, 159, 86, -20, -130, 136, -118, -252, -178, 235}, false});
    ...
    public void testUniqueOccurrences(int[] inputData, boolean expected) {
        LOGGER.debug("testUniqueOccurrences({}, {})", Arrays.toString(inputData), expected);
        LC1207UniqueNumberOfOccurrences instance = new LC1207UniqueNumberOfOccurrences();
        boolean result = instance.uniqueOccurrences(inputData);
