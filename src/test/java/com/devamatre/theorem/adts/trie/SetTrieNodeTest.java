 ...
 */
public class SetTrieNodeTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(SetTrieNodeTest.class);

    /**
     * @param inputData
     * @return
     */
    public SetTrieNode buildTrieNode(List<String> inputData) {
        SetTrieNode trieNode = new SetTrieNode('-');
     ...
     * @return
     */
    public SetTrieNode buildTrieNode() {
        SetTrieNode trieNode = new SetTrieNode('-');
    ...
    public void testInsert(List<String> inputData, int expected) {
        ...
        SetTrieNode trieNode = buildTrieNode(inputData);
    ...
    public void testFind(String inputData, boolean expected) {
        ...
        SetTrieNode trieNode = buildTrieNode();
