 ...
 */
public class GraphWithAdjacencyMatrixTest extends AbstractGraphTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(GraphWithAdjacencyMatrixTest.class);
    ...
    public void testGraph() {
        GraphWithAdjacencyMatrix graph = new GraphWithAdjacencyMatrix();
        createGraph(graph);
