 ...
 */
public class LC219ContainsDuplicateIITest {

    private static Logger LOGGER = LoggerFactory.getLogger(LC219ContainsDuplicateIITest.class);
    ...
    public void testContainsNearbyDuplicate(int[] inputData, int target, boolean expected) {
        ...
        LC219ContainsDuplicateII instance = new LC219ContainsDuplicateII();
