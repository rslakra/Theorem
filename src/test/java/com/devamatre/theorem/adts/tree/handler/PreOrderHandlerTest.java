 ...
 */
public class PreOrderHandlerTest extends AbstractTreeHandlerTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(PreOrderHandlerTest.class);
    ...
    public TreeHandler buildTreeHandler() {
        ...
        TreeHandler<Integer> treeHandler = new PreOrderHandler<>();
        assertNotNull(treeHandler);
        LOGGER.debug("treeHandler:{}", treeHandler);
        assertEquals(TraversalMode.PRE_ORDER_TRAVERSAL, treeHandler.getTraversalMode());
        assertEquals(PreOrderHandler.class, treeHandler.getClass());
    ...
    public void testTreeConverterIncludeNullLeafs() {
        ...
        expected = new Integer[]{1, 2, 4, -1, -1, 5, -1, -1, 3, -1, 6, 7, -1, -1, 8, -1, -1};
