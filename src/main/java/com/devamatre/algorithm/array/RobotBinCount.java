 ...
 *******************************************************************************/
package com.devamatre.algorithms.arrays;
...
public class RobotBinCount {
	...
	/**
	 * How many times will a robot need to retrieve bins if it is given an array
	 * of bin ID's and it can only hold N bins at a time? When the robot is
	 * already holding N bins, it will return the least recently retrieved bin
	 * and store the new bin.
	 * 
	 * @param array
	 * @param size
	 * @return
